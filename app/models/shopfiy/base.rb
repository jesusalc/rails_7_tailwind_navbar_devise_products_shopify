...
require '../shopfiy/countable'
require '../shopfiy/version'
...
module Shopify
  class Base < ActiveResource::Base
    ...
    headers['User-Agent'] =
      %W[Shopify/#{Shopify::VERSION} ActiveResource/#{ActiveResource::VERSION::STRING} Ruby/#{RUBY_VERSION}].join(' ')
    ...
    class << self
      ...
      def activate_session(session)
        ...
        headers.merge!('X-Shopify-Access-Token' => session.token)
      end
